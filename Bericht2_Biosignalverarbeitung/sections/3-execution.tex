...
-> HIER WERT EINFÜGEN <- \newline
Das entspricht umgerechnet etwa:
\begin{itemize}
    \item HIER WERT EINFÜGEN $Joule$
    \item HIER WERT EINFÜGEN $Kalorien$
    \item HIER WERT EINFÜGEN $Rittersportafeln$
    \item HIER WERT EINFÜGEN $Bier$
    \item HIER WERT EINFÜGEN $Anteil des Kalorienbedarfs von Lasse$
\end{itemize}