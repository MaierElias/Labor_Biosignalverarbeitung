...
\begin{figure}[h]
    ...
    \caption{Serieller Plotter mit und ohne Netzanschluss}
...
In Abbildung \ref{fig:ecg_with_marked_waves_elias} ist das EKG-Signal von Elias mit den markierten P-, QRS- und T-Wellen dargestellt.
- Hier muss noch genau auf die Fragestellung eingegangen werden -
...
Die Positionen der R-Zacken wurden mit den in \cite{Lab2Code1.ino} bereitgestellten Algorithmen bestimmt.
- Hier muss noch genau auf die Fragestellung eingegangen werden -
