...
Die Belastungsphase ist in Abbildung \ref{fig:hrwithaverages1} durch den mittleren Abschnitt des Plots gekennzeichnet.
Der Start der Belastungsphase ist durch den linken vertikalen Strich markiert.
...
zusammensetzt, nicht instantan reagieren können. Somit steigt der Cardiac Output erst verzögert an, sobald
Die Belastungsphase ist in Abbildung \ref{fig:hr_with_averages1} durch den mittleren Abschnitt des Plots gekennzeichnet.
Der Start der Belastungsphase ist durch den linken vertikalen Strich markiert. sowohl die Herzfrequenz als auch das 
...
\begin{figure}[h]
    ...
    \label{fig:hrwithaverages1}
\end{figure}

\subsection{Aufgabe 10: Erholungsphase nach Belastungs-EKG}
Der Start der Erholungsphase ist in Abbildung \ref{fig:hrwith_averages1} durch den rechten vertikalen Strich gekennzeichnet.
Die Herzfrequenz kehrt nach Ende der Belastung beinahe zum ursprünglichen Ruhepuls zurück. 
...
In der Funktion \texttt{analyze\_ecg\_and\_plot()} aus der Datei \cite{analyzeHearthdata} wurde die Formel zur Berechnung des Energieverbrauchs 
aus Model 1 für Männer aus dem Paper \cite{Hiilloskorpi2003HeartRateEnergyExpenditure} implementiert. Die Berechnung des Energieverbrauchs 
fehlt, weshalb nur der zugehörige Text geschrieben wurde.
\newline
...
Trend ist in der Abbildung klar erkennbar.


\subsection{Aufgabe 12: Einordnung des Energieverbrauchs und entsprechender Code}
Für die Aufgabe 12 gilt das selbe wie für Aufgabe 11, es fehlen die Werte, die Funktion zur Berechnung ist allerdings fertig.
