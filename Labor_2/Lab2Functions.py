...
def txt_to_csv(file_path, save_path):
    """This function converts a txt file to a csv file
    Input: file path of the txt file, save path of the csv file
    Output: csv file"""
...
#txt_to_csv('Labor_2/Daten_L2/Daten_mitNetzteil.txt', 'Labor_2/Daten_L2/Daten_mitNetzteil.csv')