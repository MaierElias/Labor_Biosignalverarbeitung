...
Wie in Abbildung \ref{fig:frequenzanalyse} dargestellt, zeigt das Leistungsspektrum des EMG-Signals eine 
...
\begin{figure}[h]
    ...
    \caption{Frequenzanalyse des EMG-Signals während des Ermüdungsversuches}
    \label{fig:frequenzanalyse}
\end{figure}
