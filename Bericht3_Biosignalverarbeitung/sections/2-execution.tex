...
\begin{figure}[h]
    ...
    \caption{Aufbau des Messsystems mit Beschriftung der einzelnen Komponenten}
...
I2C wurde auf eine Baudrate von 500000 bps eingestellt, um eine ausreichend schnelle Datenübertragung zu gewährleisten.
...
Im vierten und letzten Teil der Abbildung ist die Einhüllende des EMG-Signals dargestellt, die die Amplitudenmodulation des Signals verdeutlicht und eine bessere Visualisierung der Muskelaktivität ermöglicht.
...
HIER FEHLEN WERTE und kurze Erklärung, warum sich diese unterscheiden könnten.
...
Wie Abbildung \ref{fig:mvc_weights} zeigt, ist eine deutlich geringere Muskelaktivierung im 
Vergleich zur ausgangs-MVC zu erkennen. Die gemessene Aktivität liegt erwartungsgemäß bei einem Bruchteil der maximalen 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{../Labor_3/data_analysis/frequenzanalyse.png}
...
während des Ermüdungsexperiments dargestellt. Die Analyse zeigt eine leichte Verschiebung der
spektralen Anteile hin zu niedrigeren Frequenzen im Verlauf der Haltearbeit. Dies ist ein typisches
Phänomen, das auf die Ermüdung der Muskulatur zurückzuführen ist. Wir haben uns hier bewusst für die Darstellung der drei Fatigue-Durchläufe entschieden,
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/weight1.png}
