...
\begin{comment}
    Hier brauchen wir das Blockschaltbild mit zwei Sätzen zur Erklärung der BUS Typen und Geschwindigkeiten.
    Zudem auch für die einzelnen Komponenten.
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{figures/blockschaltbild.png}
    \caption{Blockschaltbild des Messsystems}
    \label{fig:blockschlaltbild}
\end{figure}
\end{comment}
\begin{table}[ht]
  \centering
